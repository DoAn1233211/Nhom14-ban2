        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Sửa loại mì</h4>
                </div>
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb justify-content-end">
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0)">Loại mì</a>
                            </li>
                            <li class="breadcrumb-item active">Sửa loại mì</li>
                        </ol>
            ...
            <!-- ============================================================== -->
            <!-- Star content -->
            <form action="index.php?act=update_lm" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="mt-4">
                <div class="form-group">
                    <input type="hidden" name="id" value="<?= $id ?>">
                    <label for="txtTitle " class="form-label" id="lblTitle">Tên loại mì</label>
                    <input type="text" class="form-control" required name="name" id="txtTitle" placeholder="Nhập tên loại mì" style="margin-bottom: 10px;" value="<?= $name ?>">
                    <label for="txtTitle " class="form-label" id="lblTitle">Giá</label>
                    <input type="text" class="form-control" required name="price" id="txtTitle" placeholder="Nhập tên loại mì" style="margin-bottom: 10px;" value="<?= $price ?>">
                ...
                <a href="index.php?act=list_lm"><button type="button" class="btn waves-effect waves-light btn-danger">Hủy</button></a>
            </form>
            <!-- End content -->
        </div>
        <!-- ============================================================== -->
