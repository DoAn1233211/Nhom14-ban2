    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Thêm danh mục</h4>
            </div>
        ...
        <!-- ============================================================== -->
        <!-- Star content -->
        <form action="index.php?act=add_dm" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="mt-4">
            <div class="form-group">
                <label for="txtTitle " class="form-label" id="lblTitle">Tên danh mục</label>
                <input type="text" class="form-control" name="name" id="txtTitle" placeholder="Nhập tên danh mục" style="margin-bottom: 10px;">
